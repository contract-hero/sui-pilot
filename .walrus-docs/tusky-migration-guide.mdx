...
description: >-
  During the Tusky sunsetting period, you can continue reading your data and
  migrate to using Walrus directly or through alternative tooling.
keywords:
  - tusky
  - migration
  - migrate from tusky
  ...
  - data migration
goal:
  description: Reader can migrate their data off Tusky to Walrus before the sunset deadline
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Tusky Migration Guide?
  - How do I get started with tusky migration guide?
  - What are the requirements for tusky migration guide?
answer: >-
  During the Tusky sunsetting period, you can continue reading your data and
  migrate to using Walrus directly or through alternative tooling.
---
