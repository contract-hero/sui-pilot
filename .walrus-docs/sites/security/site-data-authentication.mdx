...
description: >-
  Guide to Walrus Sites data authentication mechanisms using SHA-256 hashes for
...
keywords:
  ...
  - portal deployment
goal:
  description: Reader can explain how Walrus Sites authenticate content with SHA-256 hashes and what the trust model covers
  requires:
    - has_frontmatter:
        - title
        - description
...
answer: >-
  Walrus Sites use SHA-256 hashes stored on Sui to verify that every resource
  served by a portal matches the content the site owner originally published.
---
