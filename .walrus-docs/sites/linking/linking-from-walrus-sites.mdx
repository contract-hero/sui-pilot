---
title: Linking from Walrus Sites to External URLs
description: >-
  How to link from Walrus Sites to external URLs, including absolute URL
  requirements, resource loading, and common outbound linking patterns.
keywords:
  - Walrus Sites
  - external links
  - absolute URL
  ...
  - CORS
goal:
  description: Reader can link from a Walrus Site to external URLs and load external resources correctly
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Linking from Walrus Sites to External URLs?
  - How do I get started with linking from walrus sites to external urls?
  - What are the requirements for linking from walrus sites to external urls?
answer: >-
  How to link from Walrus Sites to external URLs, including absolute URL
  requirements, resource loading, and common outbound linking patterns.
---
