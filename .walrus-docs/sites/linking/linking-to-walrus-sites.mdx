---
title: Linking to Walrus Sites from External Sources
description: >-
  How to construct URLs that point to Walrus Sites from external pages, apps,
  and tools, including subdomain resolution, SuiNS names, object IDs, and deep
  links.
keywords:
  - Walrus Sites
  - inbound links
  ...
  - URL
goal:
  description: Reader can construct URLs that link to a Walrus Site from external pages, apps, and tools
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Linking to Walrus Sites from External Sources?
  - How do I get started with linking to walrus sites from external sources?
  - What are the requirements for linking to walrus sites from external sources?
answer: >-
  How to construct URLs that point to Walrus Sites from external pages, apps,
  and tools, including subdomain resolution, SuiNS names, object IDs, and deep
  links.
