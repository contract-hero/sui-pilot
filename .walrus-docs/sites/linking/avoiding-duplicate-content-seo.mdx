---
title: Avoiding Duplicate Content for SEO
description: >-
  How to prevent duplicate content SEO issues when your Walrus Site is
  accessible under multiple hostnames, including canonical hints and portal
...
keywords:
  ...
  - custom domains
goal:
  description: Reader can prevent duplicate-content SEO issues when a Walrus Site is reachable under multiple hostnames
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - What is Avoiding Duplicate Content for SEO?
  - How do I get started with avoiding duplicate content for seo?
answer: >-
  How to prevent duplicate content SEO issues when your Walrus Site is
  accessible under multiple hostnames, including canonical hints and portal
  configuration options.
