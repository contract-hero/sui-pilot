---
title: Walrus Sites Redirects
description: >-
  How redirects work in Walrus Sites, including routing-based internal
  redirects, HTTP redirects, and redirecting arbitrary Sui objects to a Walrus
  Site.
keywords:
  - Walrus Sites
  - redirects
  ...
  - HTTP redirect
goal:
  description: Reader can configure internal routing, HTTP redirects, and Sui object redirects for a Walrus Site
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Walrus Sites Redirects?
  - How do I get started with walrus sites redirects?
  - What are the requirements for walrus sites redirects?
answer: >-
  How redirects work in Walrus Sites, including routing-based internal
  redirects, HTTP redirects, and redirecting arbitrary Sui objects to a Walrus
  Site.
