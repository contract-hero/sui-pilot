...
description: >-
  Complete guide to configuring a custom DNS domain for a Walrus Site by
...
goal:
  description: Reader can serve a Walrus Site from their own DNS domain by deploying and pointing to a local portal
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I configure your portal?
  - How do I deploy your portal to a server?
  - How do I configure your dns?
answer: >-
  Complete guide to configuring a custom DNS domain for a Walrus Site by
  deploying a local portal and pointing your domain to it.
---
