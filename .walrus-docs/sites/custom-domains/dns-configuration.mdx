---
title: Portal DNS Configuration
description: >-
  Guide to configuring DNS records to point your custom domain to a self-hosted
  Walrus Sites portal.
keywords:
  - walrus sites
  - custom domain
  ...
  - tls
goal:
  description: Reader can configure DNS records and HTTPS to point a custom domain at a self-hosted Walrus Sites portal
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I set up https with a reverse proxy?
  - How do I verify dns propagation?
  - What is Portal DNS Configuration?
answer: >-
  After [setting up your portal and configuring it for your
  domain](/docs/sites/custom-domains/bringing-your-own-domain), you need to
  configure your domain's DNS to route traffic to the server running your
  portal.
---
