---
title: Setting a SuiNS Name
description: >-
  Complete guide to registering a SuiNS name and linking it to a Walrus Site for
  human-readable URLs on the wal.app portal.
keywords:
  - walrus sites
  - suins
  - domain names
  ...
  - custom domain
goal:
  description: Reader can register a SuiNS name and link it to a Walrus Site for a human-readable wal.app URL
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I register a suins name?
  - How do I set a SuiNS name for my Walrus Site?
  - How do I get started with setting a suins name?
answer: >-
  Complete guide to registering a SuiNS name and linking it to a Walrus Site for
  human-readable URLs on the wal.
---
