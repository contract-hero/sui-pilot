---
title: Troubleshooting Walrus Sites
description: Solutions to common errors when deploying and browsing Walrus Sites.
keywords:
  - walrus sites
  - troubleshooting
  - site-builder
  ...
  - deployment errors
goal:
  description: Reader can diagnose and fix common errors when deploying or browsing a Walrus Site
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Troubleshooting Walrus Sites?
  - How do I get started with troubleshooting walrus sites?
answer: Solutions to common errors when deploying and browsing Walrus Sites.
---
...
**Solution:** Open the [SuiNS app](https://suins.io/), navigate to your name's settings, and verify the linked object ID matches the output from your most recent `site-builder deploy`. Allow a few minutes for changes to propagate, then hard-refresh your browser (<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>R</kbd> or <kbd>Cmd</kbd>+<kbd>Shift</kbd>+<kbd>R</kbd>).
