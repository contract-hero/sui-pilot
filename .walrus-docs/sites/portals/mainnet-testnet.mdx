...
keywords:
  ...
  - SuiNS
goal:
  description: Reader can configure a local Walrus Sites portal for Mainnet or Testnet
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I configure a local sites portal?
  - How do I testnet?
  - How do I get started with configure a local sites portal?
answer: >-
  Walrus Site Portals are used to access and browse a Walrus Site. The portal
  you run **must** match the network on which your site is deployed.
---
