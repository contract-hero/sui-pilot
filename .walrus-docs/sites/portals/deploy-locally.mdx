...
keywords:
  ...
  - bun
goal:
  description: Reader can deploy a Walrus Sites portal locally for development or self-hosting
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I deploy a local portal?
  - How do I get started with deploy a local portal?
  - What are the requirements for deploy a local portal?
answer: Guide to deploying a local Walrus Sites portal.
---
