...
description: >-
  How to write and configure a GitHub Actions workflow for automated Walrus
  Sites deployment, including build steps, action inputs, ws-resources.json
...
keywords:
  ...
  - ws-resources.json
goal:
  description: Reader can configure a GitHub Actions workflow that builds and deploys a Walrus Site automatically
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - How do I get started with github actions workflow?
answer: >-
  How to write and configure a GitHub Actions workflow for automated Walrus
  Sites deployment, including build steps, action inputs, ws-resources.json
  tracking, and troubleshooting.
