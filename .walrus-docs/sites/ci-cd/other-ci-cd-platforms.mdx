...
description: >-
  How to automate Walrus Sites deployment on GitLab CI/CD, CircleCI, Bitbucket
  Pipelines, and any other CI/CD platform using the site-builder CLI directly.
keywords:
  - walrus sites
  - ci/cd
  - gitlab
  ...
  - pipeline
goal:
  description: Reader can automate Walrus Site deployment on GitLab, CircleCI, Bitbucket, or any platform using the site-builder CLI
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - What is Other CI/CD Platforms?
  - How do I get started with other ci/cd platforms?
answer: >-
  How to automate Walrus Sites deployment on GitLab CI/CD, CircleCI, Bitbucket
  Pipelines, and any other CI/CD platform using the site-builder CLI directly.
---
