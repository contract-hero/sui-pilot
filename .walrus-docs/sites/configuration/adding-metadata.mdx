...
description: Reference page for adding metadata to a Walrus Site.
keywords:
  - walrus sites
  - metadata
  - ws-resources
...
draft: false
goal:
  description: Reader can add display metadata such as link, image, description, and creator to a Walrus Site
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - How do I get started with adding metadata?
  - What are the requirements for adding metadata?
answer: Reference page for adding metadata to a Walrus Site.
---
