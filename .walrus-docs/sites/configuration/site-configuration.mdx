...
description: >-
  Guide to using ws-resources.json to configure a Walrus Site, including
  specifying HTTP headers, setting up client-side routing, and adding metadata.
keywords:
  - walrus sites
  - headers
  - content-type
  ...
  - spa
goal:
  description: Reader can use ws-resources.json to configure headers, routing, redirects, and metadata for a Walrus Site
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - How do I get started with site configuration?
answer: Guide to using ws-resources.
---
