...
description: "Guide to using ws-resources.json to configure a Walrus Site, including specifying HTTP headers, setting up client-side routing, and adding metadata."
keywords: ["walrus sites", "headers", "content-type", "ws-resources", "configuration", "site-builder", "routing", "metadata", "client-side routing", "spa"]
---
