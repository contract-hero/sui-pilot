...
description: >-
  Complete guide to site-builder commands for publishing and updating a Walrus
  Site.
keywords:
  - walrus sites
  - site builder
  ...
  - publish
goal:
  description: Reader can look up the site-builder commands for publishing and updating a Walrus Site
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Site Builder Reference?
  - How do I get started with site builder reference?
  - What are the requirements for site builder reference?
answer: >-
  Complete guide to site-builder commands for publishing and updating a Walrus
  Site.
---
