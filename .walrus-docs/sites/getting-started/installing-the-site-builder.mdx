...
description: >-
  Step-by-step guide to installing and setting up the Walrus Sites site-builder
...
keywords:
  ...
  - configuration
goal:
  description: Reader can install and configure the site-builder tool on their platform
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I install the site builder?
  - How do I installation?
  - How do I get started with install the site builder?
answer: >-
  The `site-builder` is a CLI tool that lets you create, edit, and publish
  Walrus Sites. You can install it using
  [`suiup`](https://github.com/MystenLabs/suiup) or a pre-built binary.
---
