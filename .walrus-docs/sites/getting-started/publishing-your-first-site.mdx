...
description: >-
  Tutorial for publishing, viewing, and updating your first Walrus Site using
  the site-builder tool with example projects.
keywords:
  - walrus sites
  - publishing
  - deployment
  ...
  - examples
goal:
  description: Reader can publish, view, and update their first Walrus Site with the site-builder tool
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I deploy a walrus site?
  - How do I deploy an example site?
  - How do I get started with deploy a walrus site?
answer: >-
  Tutorial for publishing, viewing, and updating your first Walrus Site using
  the site-builder tool with example projects.
---
