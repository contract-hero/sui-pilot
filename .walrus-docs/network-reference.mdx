...
{/* scripts/generate_network_reference.py generates the volatile values below from canonical sources. Do not edit content inside GENERATED markers by hand; edit the source files or scripts/network_reference_data.yaml and rerun the generator. */}
