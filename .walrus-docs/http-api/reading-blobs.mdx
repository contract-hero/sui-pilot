...
title: Reading Blobs
description: >-
  Read blobs from Walrus using HTTP GET requests with blob IDs or Sui object
...
keywords:
  ...
  - consistency check
goal:
  description: Reader can read blobs from Walrus over HTTP by blob ID or Sui object ID and control consistency checks
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I read by blob id?
  - How do I read by object id?
  - How do I read blobs?
answer: >-
  Read blobs from Walrus using HTTP GET requests with blob IDs or Sui object
  IDs, including content type headers and consistency check options.
