...
title: Storing Blobs
description: >-
  Store blobs on Walrus using HTTP PUT requests through a publisher, with
  options for storage duration, deletability, and object ownership.
keywords:
  - walrus
  - HTTP
  - API
  ...
  - quilt
goal:
  description: Reader can store blobs over HTTP through a publisher and set duration, deletability, and object ownership
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I configure storage options?
  - What is Storing Blobs?
  - How do I store blobs using the HTTP API?
answer: >-
  Store blobs on Walrus using HTTP PUT requests through a publisher, with
  options for storage duration, deletability, and object ownership.
---
