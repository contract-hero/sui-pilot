---
title: Quilt HTTP APIs
description: >-
  Store and retrieve multiple blobs as a single quilt using the Walrus HTTP API,
  including quilt storage, patch IDs, and retrieval by identifier.
keywords:
  - walrus
  - HTTP
  - API
  ...
  - aggregator
goal:
  description: Reader can store and retrieve multiple blobs as a single quilt through the HTTP API using quilt IDs, patch IDs, and identifiers
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I read quilts?
  - What is Quilt HTTP APIs?
  - >-
    How do I store and retrieve multiple blobs as a single quilt using the
    walrus http api, including quilt storage, patch ids, and retrieval by
    identifier?
answer: >-
  Store and retrieve multiple blobs as a single quilt using the Walrus HTTP API,
  including quilt storage, patch IDs, and retrieval by identifier.
