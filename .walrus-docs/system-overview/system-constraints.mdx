---
title: System Constraints & Considerations
description: >-
  Storage limits, cost considerations, memory requirements, and other
  constraints to consider when building on Walrus.
keywords:
  - walrus
  - constraints
  - blob size
  ...
  - quilt
goal:
  description: Reader can account for Walrus size limits, rate limits, and other constraints when designing an application
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is System Constraints & Considerations?
  - How do I get started with system constraints & considerations?
  - What are the requirements for system constraints & considerations?
answer: >-
  Storage limits, cost considerations, memory requirements, and other
  constraints to consider when building on Walrus.
---
