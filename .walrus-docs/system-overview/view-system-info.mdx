...
description: >-
  Use the walrus info command to view Walrus system parameters, storage node
  details, epoch information, and current storage costs.
keywords:
  - walrus
  - system information
  - walrus info
  ...
  - system object
goal:
  description: Reader can use walrus info and walrus health to inspect system parameters and node status
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is View System Information?
  - >-
    How do I use the walrus info command to view walrus system parameters,
    storage node details, epoch information, and current storage costs?
  - How do I get started with view system information?
answer: >-
  Use the walrus info command to view Walrus system parameters, storage node
  details, epoch information, and current storage costs.
---
