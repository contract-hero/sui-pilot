...
title: Upload Relay
description: >-
  Learn how the Walrus upload relay simplifies blob uploads by batching
  requests, handling retries, and generating certificates on behalf of your
  application.
keywords:
  - walrus
  - typescript
  ...
  - retry
goal:
  description: Reader can decide when to use the upload relay and explain how it batches, retries, and certifies uploads
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - What is Upload Relay?
answer: >-
  An upload relay is a server-side service that simplifies the upload process by
  handling the complexity of writing to multiple storage nodes.
---
