...
description: >-
  Overview of Walrus networks including Mainnet and Testnet configurations,
  parameters, and setup instructions.
keywords:
  - walrus
  - networks
  - mainnet
  ...
  - network parameters
goal:
  description: Reader can compare Walrus Mainnet and Testnet parameters and set up the network they need
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I configure Walrus for Testnet?
  - How do I run a local walrus network?
  - What is Available Networks?
answer: >-
  Overview of Walrus networks including Mainnet and Testnet configurations,
  parameters, and setup instructions.
---
