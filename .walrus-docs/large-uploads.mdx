...
description: >-
  Configuration, memory planning, and pipeline design patterns for uploading
  large data to Walrus.
keywords:
  - large data
  - large upload
  - workaround
  ...
  - ingestion pipeline
goal:
  description: Reader can tune configuration, memory, and pipeline design to reliably upload large blobs to Walrus
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I use local tooling for upload observability?
  - How do I manage upload throughput?
  - How do I manage memory for concurrent uploads?
answer: >-
  The maximum blob size on Walrus is approximately 13.6 GB. Uploading large data
  sets or individual blobs larger than 1 GB require certain workarounds and
  planning for optimal performance and efficiency.
---
