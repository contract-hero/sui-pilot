...
description: >-
  Use the Walrus client to check, extend, delete, burn, share, and set
  attributes on blobs across their lifecycle.
keywords:
  - walrus
  - cli
  - client
  ...
  - monitoring
goal:
  description: Reader can check, extend, delete, burn, share, and set attributes on blobs across their lifecycle with the Walrus client
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I check a blob's status and expiry?
  - How do I extend the lifetime of a blob?
  - How do I delete blobs?
answer: >-
  Use the Walrus client to check, extend, delete, burn, share, and set
  attributes on blobs across their lifecycle.
---
