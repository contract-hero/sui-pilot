---
title: Using Quilts with the Walrus Client
sidebar_label: Quilts
description: >-
  Use the Walrus client to batch multiple blobs into quilts for efficient
...
keywords:
  ...
  - QuiltPatchId
goal:
  description: Reader can batch blobs into quilts and read them back using the Walrus client
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I store files as a quilt?
  - How do I read blobs from a quilt?
  - What is Using Quilts with the Walrus Client?
answer: >-
  Use the Walrus client to batch multiple blobs into quilts for efficient
  storage and retrieval.
---
