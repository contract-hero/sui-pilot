...
description: Store blobs from a browser or mobile client through a Walrus upload relay, then read
  them back through a CDN-backed aggregator.
keywords: [walrus, browser, mobile, upload relay, aggregator, CDN, client app, typescript sdk, react native]
---
