...
description: >-
  Complete getting started guide for Walrus including installation,
  configuration, storing and retrieving blobs on Testnet and Mainnet.
keywords:
  - walrus
  - getting started
  - tutorial
  ...
  - setup
goal:
  description: Reader can install Walrus, choose an upload path, and store and retrieve their first blob on Testnet or Mainnet
  requires:
    - pattern: '```'
      min: 2
    ...
    - pattern: walrus --version|walrus -V|walrus --help
      min: 1
...
questions:
  - How do I install and set up Walrus?
  - How do I store my first blob on Walrus?
  - How do I retrieve a blob from Walrus?
answer: >-
  Complete getting started guide for Walrus including installation,
  configuration, storing and retrieving blobs on Testnet and Mainnet.
---
...
:::caution Mainnet publisher availability
