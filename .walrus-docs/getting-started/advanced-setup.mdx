...
description: >-
  Advanced installation options for Walrus including building from source and
  binary installation.
keywords:
  - walrus
  - installation
  ...
  - advanced setup
goal:
  description: Reader can install Walrus through Nix, Cargo, source, or on Windows when the standard installer does not fit their environment
  requires:
    - pattern: '```'
      min: 2
...
questions:
  - How do I install Walrus on Windows?
  - How do I install Walrus from source or Nix?
  - How do I configure Walrus after installation?
answer: >-
  Advanced installation options for Walrus including building from source and
  binary installation.
---
