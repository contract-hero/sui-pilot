...
keywords:
  ...
  - configuration
goal:
  description: Reader can identify the cause of a specific Walrus CLI or network error and apply the fix
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I fix Walrus connectivity errors?
  - What is Troubleshooting Common Errors?
  - How do I get started with troubleshooting common errors?
answer: 'Common errors in the Walrus CLI and network, with causes and solutions.'
---
