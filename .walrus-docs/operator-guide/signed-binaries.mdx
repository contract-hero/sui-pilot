---
title: Verify Signed Binaries
description: >-
  How to download and verify signed Walrus binaries and Docker images using
  Cosign.
keywords:
  - walrus
  - signed binaries
  ...
  - release
goal:
  description: Operator can verify the authenticity of Walrus binaries and Docker images with Cosign
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I verify signed binaries?
  - How do I use the verification script?
  - How do I verify manually?
  - How do I verify docker images?
answer: >-
  Walrus release binaries and Docker images are signed using
  [Cosign](https://github.com/sigstore/cosign) with a GCP KMS key. Each binary
  has a corresponding `.sig` file containing its signature.
---
