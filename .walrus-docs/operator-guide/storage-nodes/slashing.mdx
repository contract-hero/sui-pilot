...
title: Slashing
description: >-
  Vote to slash misbehaving storage nodes through quorum-based governance that
  burns the offender's accumulated commission.
keywords:
  - slashing
  - governance
  - commission
  ...
  - execute_slashing
goal:
  description: Operator can understand how slashing works and cast a vote to slash a misbehaving storage node
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is slashing on Walrus?
  - How does the slashing process work?
  - When can a storage node be slashed?
answer: >-
  Vote to slash misbehaving storage nodes through quorum-based governance that
  burns the offender's accumulated commission.
---
