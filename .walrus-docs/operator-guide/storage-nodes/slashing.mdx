---
title: Slashing
description: Vote to slash misbehaving storage nodes through quorum-based governance that burns the offender's accumulated commission.
keywords: [ slashing, governance, commission, misbehavior, quorum, SlashingManager, vote_for_slashing, execute_slashing ]
---
