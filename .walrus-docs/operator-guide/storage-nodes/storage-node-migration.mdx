---
title: Migrate a Storage Node
description: >-
  Guide for migrating a Walrus storage node to new hardware with minimal
  downtime.
keywords:
  - walrus
  - storage node
  ...
  - operations
goal:
  description: Operator can migrate a storage node to new hardware with minimal downtime
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I migrate a storage node?
  - How do I verify the migration?
  - How do I get started with migrate a storage node?
answer: >-
  Guide for migrating a Walrus storage node to new hardware with minimal
  downtime.
---
