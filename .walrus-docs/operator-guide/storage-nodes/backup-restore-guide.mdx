...
description: >-
  Back up and restore Walrus storage node databases with automated and manual
  procedures.
keywords:
  - walrus
  - backup
  ...
  - operations
goal:
  description: Operator can set up automated backups and restore a Walrus storage node database
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I set up automated periodic backups?
  - How do I create manual backups?
  - What is Backup and Restore Guide?
answer: >-
  Back up and restore Walrus storage node databases with automated and manual
  procedures.
---
