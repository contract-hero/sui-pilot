---
title: Set Up a Storage Node
description: >-
  Step-by-step guide for setting up a Walrus storage node, including system
...
keywords:
  ...
  - jemalloc
goal:
  description: Operator can prepare a host, configure TLS, and register a new Walrus storage node
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - How do I install jemalloc for my storage node?
  - How do I create the systemd service file systemd?
answer: >-
  Step-by-step guide for setting up a Walrus storage node, including system
  preparation, TLS, configuration, and registration.
---
...
wal_price_monitor:
  ...
  enable_coingecko: true        # Fetch the WAL price from CoinGecko.
  enable_coinbase: true         # Fetch the WAL price from Coinbase.
