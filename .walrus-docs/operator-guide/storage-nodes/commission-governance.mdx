---
title: Commission and Governance
description: >-
  Manage storage node commission collection and governance operations including
  authorization and contract upgrades.
keywords:
  - commission
  - governance
  - storagenodecap
  ...
  - contract upgrades
goal:
  description: Operator can manage storage-node commission collection, authorization, and contract-upgrade voting
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I manage contract upgrades?
  - What is Commission and Governance?
  - >-
    How do I manage storage node commission collection and governance operations
    including authorization and contract upgrades?
answer: >-
  Manage storage node commission collection and governance operations including
  authorization and contract upgrades.
---
