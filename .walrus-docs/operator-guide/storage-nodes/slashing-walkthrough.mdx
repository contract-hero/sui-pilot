---
title: Slashing Walkthrough
description: >-
  A worked example of a slashing event on Mainnet, with the concrete vote,
  execute, and cleanup commands operators run end to end.
keywords:
  - slashing
  - walkthrough
  - example
  - vote_for_slashing
  - execute_slashing
  - cleanup_slashing_proposals
goal:
  description: Operator can follow a worked example to vote, execute, and clean up a storage-node slashing event on Mainnet
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Slashing Walkthrough?
  - How do I get started with slashing walkthrough?
  - What are the requirements for slashing walkthrough?
answer: >-
  A worked example of a slashing event on Mainnet, with the concrete vote,
  execute, and cleanup commands operators run end to end.
---
