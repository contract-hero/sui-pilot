...
description: >-
  Frequently asked questions about operating a Walrus storage node, including
  wallets, TLS, RPC configuration, and commission rates.
keywords:
  - walrus
  - storage node
  - FAQ
  ...
  - RPC
goal:
  description: Operator can find answers to common storage-node questions about wallets, TLS, RPC configuration, and commission
  requires:
    - has_frontmatter:
        - title
        - description
