---
title: Aggregator and Publisher Limitations
description: >-
  Request size limits, nginx caching configuration, and daemon metrics for
  Walrus aggregators and publishers.
keywords:
  - walrus
  - publisher
  - aggregator
  ...
  - limitations
goal:
  description: Operator can configure request-size limits and nginx caching, and read daemon metrics for aggregators and publishers
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I aggregator and publisher limitations?
  - How do I configure nginx caching nginx-caching?
  - How do I configure nginx caching?
answer: >-
  Request size limits, nginx caching configuration, and daemon metrics for
  Walrus aggregators and publishers.
---
