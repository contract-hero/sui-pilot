...
description: >-
  Complete guide to staking and unstaking WAL tokens with storage nodes using
  the Walrus staking app.
keywords:
  - walrus
  - staking
  - unstaking
  ...
  - dapp
goal:
  description: Reader can stake and unstake WAL with a storage node using the Walrus staking app
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I stake with the walrus staking app?
  - What is Staking and Unstaking?
  - How do I get started with staking and unstaking?
answer: >-
  Complete guide to staking and unstaking WAL tokens with storage nodes using
  the Walrus staking app.
---
