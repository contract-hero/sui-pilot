---
title: Operate a Publisher
description: Guide to setting up and operating a publisher on Walrus.
keywords:
  - walrus
  - publisher
goal:
  description: Operator can set up, fund, and run a Walrus publisher, including sub-wallets and upload concurrency
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I operate a publisher?
  - How do I create and fund the publisher wallet fund-publisher?
  - How do I run a publisher manually for testing?
answer: Guide to setting up and operating a publisher on Walrus.
---
