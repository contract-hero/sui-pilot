---
title: Use the Authenticated Publisher
description: >-
  Detailed guide for configuring and operating the Walrus authenticated
  publisher with JWT-based access control.
keywords:
  - walrus
  ...
  - token verification
goal:
  description: Operator can configure and run the authenticated publisher with JWT-based access control
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I use the authenticated publisher?
  - How do I set up the publisher?
  - How do I get started with use the authenticated publisher?
answer: >-
  Detailed guide for configuring and operating the Walrus authenticated
  publisher with JWT-based access control.
---
