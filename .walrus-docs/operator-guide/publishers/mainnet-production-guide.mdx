...
keywords:
  ...
  - upload relay
goal:
  description: Operator can run a private Mainnet publisher securely, controlling wallet access, cost exposure, CORS, and failover
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I mainnet publisher production guide?
  - How do I choose the right upload path?
  - How do I configure cors intentionally?
answer: Production guidance for running private Mainnet publishers on Walrus.
---
