---
title: Walrus SDK
description: Store and retrieve blobs on Walrus decentralized storage using the TypeScript SDK.
keywords:
  [Walrus SDK, decentralized storage, blob storage, Sui, TypeScript, upload, '@mysten/walrus']
---
