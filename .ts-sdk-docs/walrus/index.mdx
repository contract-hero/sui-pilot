...
keywords:
  ...
  - '@mysten/walrus'
questions:
  - What is the Walrus SDK?
  - How do I upload data to Walrus?
  - How do I download blobs from Walrus?
answer: >-
  The Walrus SDK (@mysten/walrus) provides TypeScript bindings for storing and retrieving blobs on
  Walrus decentralized storage, with support for upload, download, and blob metadata.
goal:
  description: Reader can store and retrieve blobs on Walrus decentralized storage
  requires:
    - has_frontmatter:
        - title
        - description
