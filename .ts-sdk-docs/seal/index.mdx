...
keywords:
  ...
  - decentralized
questions:
  - What is the Seal SDK?
  - How do I encrypt data with Seal?
  - How does threshold encryption work in Seal?
answer: >-
  The Seal SDK (@mysten/seal) provides decentralized secrets management with threshold encryption on
  Sui, letting you encrypt data with onchain access policies and decrypt through key servers.
goal:
  description: >-
    Reader understands the Seal SDK and can encrypt/decrypt data with threshold encryption on Sui
  requires:
    - has_frontmatter:
        - title
        - description
