...
description: Create and customize zkSend claim links for sending Sui assets.
keywords:
  - zkSend
  - link builder
  - claim links
  ...
  - TypeScript
questions:
  - What is Creating zkSend Links?
  - How do I use Creating zkSend Links?
  - How does Limitations work?
  - How does Create a link work?
answer: Create and customize zkSend claim links for sending Sui assets.
goal:
  description: Reader can create and customize zkSend claim links for sending Sui assets
  requires:
    - has_frontmatter:
        - title
        - description
