...
description: Encode and decode Sui Move types with Binary Canonical Serialization.
keywords:
  - BCS
  ...
  - '@mysten/bcs'
questions:
  - What is BCS in the Sui SDK?
  - How do I serialize Move types in TypeScript?
  - How do I decode BCS data?
answer: >-
  The BCS library (@mysten/bcs) provides Binary Canonical Serialization for encoding and decoding
  Sui Move types in TypeScript, supporting structs, enums, vectors, and all Move primitive types.
goal:
  description: Reader can encode and decode Sui Move types using BCS in TypeScript
  requires:
    - has_frontmatter:
        - title
        - description
