...
description: Sign and execute a transaction on the Sui network using the connected wallet.
keywords:
  - sign and execute
  - transaction
  - dApp Kit
  ...
  - transfer
questions:
  - How do I sign and execute transaction with Sui dApp Kit?
  - What does Sign and Execute Transaction do?
  - How does Parameters work?
  - How does Return value work?
answer: Sign and execute a transaction on the Sui network using the connected wallet.
goal:
  description: >-
    Reader can sign and execute a transaction on the Sui network using the connected wallet
  requires:
    - has_frontmatter:
        - title
        - description
