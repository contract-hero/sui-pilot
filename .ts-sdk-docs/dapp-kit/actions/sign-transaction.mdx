...
description: Sign a Sui transaction without executing it for deferred or multi-signature scenarios.
keywords:
  [sign transaction, dApp Kit, multi-signature, transaction signing, Sui, wallet, TypeScript]
---
