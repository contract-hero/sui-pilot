...
keywords:
  ...
  - TypeScript
questions:
  - How do I sign transaction with Sui dApp Kit?
  - What does Sign Transaction do?
...
goal:
  description: >-
    Reader can sign a Sui transaction without executing it for deferred or multi-signature scenarios
  requires:
    - has_frontmatter:
        - title
        - description
