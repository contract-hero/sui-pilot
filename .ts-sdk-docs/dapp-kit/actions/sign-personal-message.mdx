...
questions:
  - How do I sign personal message with Sui dApp Kit?
  - What does Sign Personal Message do?
...
goal:
  description: >-
    Reader can sign an arbitrary message with the connected wallet for authentication or proof of
    ownership
  requires:
    - has_frontmatter:
        - title
