...
description: Create and configure a DAppKit instance for wallet and client management
questions:
  - What is DApp Kit Instance?
  - How do I use DApp Kit Instance?
  - How does Creating a dApp Kit instance work?
...
keywords:
  ...
  - configuration
  - Sui
answer: Create and configure a DAppKit instance for wallet and client management
goal:
  description: >-
    Reader can create and configure a DAppKit instance for wallet and client management
  requires:
    - has_frontmatter:
        - title
        - description
