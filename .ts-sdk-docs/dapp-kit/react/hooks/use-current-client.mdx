...
keywords:
  ...
  - TypeScript
questions:
  - What does the useCurrentClient hook do?
  - How do I use useCurrentClient?
  - How does Return value work?
answer: React hook to get the current Sui client instance for the active network
goal:
  description: >-
    Reader can use the React hook to get the current Sui client instance for the active network
  requires:
    - has_frontmatter:
        - title
        - description
