---
title: useDAppKit
description: React hook to access the full dApp Kit instance for calling actions directly.
keywords:
  - useDAppKit
  - React hook
  - dApp Kit
  ...
  - TypeScript
questions:
  - What does the useDAppKit hook do?
  - How do I use useDAppKit?
  - How does Return value work?
answer: React hook to access the full dApp Kit instance for calling actions directly.
goal:
  description: >-
    Reader can use the React hook to access the full dApp Kit instance for calling actions directly
  requires:
    - has_frontmatter:
        - title
        - description
