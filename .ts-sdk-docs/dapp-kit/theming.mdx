---
title: Theming
description: Customize the appearance of dApp Kit UI components.
keywords:
  - theming
  - CSS variables
  - shadcn/ui
  ...
  - styling
questions:
  - How do I theme dApp Kit components?
  - How do I customize the ConnectButton style?
  - Does dApp Kit support dark mode?
answer: >-
  DApp Kit components support theming through CSS variables and a theme configuration object,
  including light/dark mode and custom color schemes.
goal:
  description: Reader can customize the appearance of dApp Kit UI components
  requires:
    - has_frontmatter:
        - title
        - description
