...
description: Create a Sui app with one command using the create-dapp CLI scaffolding tool.
keywords:
  - create-dapp
  - CLI
  - scaffolding
  ...
  - project template
questions:
  - What is @mysten/create-dapp?
  - How do I use @mysten/create-dapp?
  - How does Quick start work?
  - How does Templates work?
answer: Create a Sui app with one command using the create-dapp CLI scaffolding tool.
goal:
  description: >-
    Reader can create a Sui app with one command using the create-dapp CLI scaffolding tool
  requires:
    - has_frontmatter:
        - title
        - description
