...
questions:
  - What is React?
  - How do I use React?
  - How does Quick start with create-dapp work?
  - How does Manual installation work?
answer: Set up dApp Kit in a React application
goal:
  description: Reader can set up dApp Kit in a React application
  requires:
    - has_frontmatter:
        - title
        - description
