---
title: Next.js
description: Set up dApp Kit in a Next.js application.
keywords:
  - Next.js
  - dApp Kit
  - SSR
...
questions:
  ...
  - How does Setup work?
  - 'How does Alternative: single client component work?'
answer: Set up dApp Kit in a Next.js application.
goal:
  description: Reader can set up dApp Kit in a Next.js application
  requires:
    - has_frontmatter:
        - title
        - description
