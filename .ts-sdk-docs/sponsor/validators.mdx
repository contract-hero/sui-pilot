...
questions:
  ...
  - 'How does Loading data, and sharing it across validators work?'
  - How does Request-scoped options work?
answer: Compose built-in and custom validation analyzers for sponsorship policy
goal:
  description: >-
    Reader can compose built-in and custom validation analyzers for sponsorship policy
  requires:
    - has_frontmatter:
        - title
        - description
