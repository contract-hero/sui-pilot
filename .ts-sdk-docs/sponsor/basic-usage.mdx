...
questions:
  - What is Basic Usage?
  - How do I use Basic Usage?
  - How does Recommended flow work?
  - How does Provide the sponsor address work?
answer: Build a service that validates and executes user-signed sponsored bytes
goal:
  description: >-
    Reader can build a service that validates and executes user-signed sponsored bytes
  requires:
    - has_frontmatter:
        - title
        - description
