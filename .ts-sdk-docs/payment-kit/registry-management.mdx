...
keywords:
  ...
  - '@mysten/payment-kit'
questions:
  - What is Registry Management?
  - How do I use Registry Management?
  - How does Understanding payment registries work?
  - How does Creating a registry work?
answer: >-
  Create, configure, and manage payment registries and accepted coin types on Sui.
goal:
  description: >-
    Reader can create, configure, and manage payment registries and accepted coin types on Sui
  requires:
    - has_frontmatter:
        - title
        - description
