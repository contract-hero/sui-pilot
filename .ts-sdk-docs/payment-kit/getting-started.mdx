...
description: Install and set up Payment Kit for your Sui application.
keywords:
  - Payment Kit
  - getting started
  - installation
...
questions:
  ...
  - How do I use Getting Started?
  - How does Setting up the client work?
  - How does Your first payment work?
answer: Install and set up Payment Kit for your Sui application.
goal:
  description: Reader can install and set up Payment Kit for your Sui application
  requires:
    - has_frontmatter:
        - title
        - description
