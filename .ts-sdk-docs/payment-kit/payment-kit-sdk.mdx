...
description: Payment Kit SDK API reference and configuration for the PaymentKitClient.
keywords:
  - Payment Kit SDK
  - API reference
  - PaymentKitClient
  ...
  - '@mysten/payment-kit'
questions:
  - What is Payment Kit SDK?
  - How do I use Payment Kit SDK?
  - How does Client setup work?
  - How does Transaction methods work?
answer: Payment Kit SDK API reference and configuration for the PaymentKitClient.
goal:
  description: >-
    Reader understands payment Kit SDK API reference and configuration for the PaymentKitClient
  requires:
    - has_frontmatter:
        - title
        - description
