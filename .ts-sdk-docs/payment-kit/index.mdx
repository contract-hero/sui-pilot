...
questions:
  - What is Payment Kit?
  - How do I accept crypto payments on Sui?
  - How does payment processing work with Payment Kit?
answer: >-
  Payment Kit accepts payments in any coin type on Sui with built-in duplicate prevention, receipt
  tracking, and a registry for managing payment destinations.
goal:
  description: Reader understands how to accept payments on Sui with Payment Kit
  requires:
    - has_frontmatter:
        - title
        - description
