...
questions:
  ...
  - How do I use Payment Processing?
  - How does Payment models overview work?
  - How payment keys work?
answer: >-
  Process registry-based and ephemeral payments and handle transaction results on Sui.
goal:
  description: >-
    Reader understands process registry-based and ephemeral payments and handle transaction results
    on Sui
  requires:
    - has_frontmatter:
        - title
