...
description: Complete reference for transaction commands and input types
keywords:
  - reference
  - commands
  - inputs
  ...
  - upgrade
questions:
  - How do I commands and inputs reference with Sui dApp Kit?
  - What does Commands and Inputs Reference do?
  - How does Passing inputs work?
  - How does Object inputs work?
answer: Complete reference for transaction commands and input types
goal:
  description: >-
    Reader understands complete reference for transaction commands and input types
  requires:
    - has_frontmatter:
        - title
        - description
...
<Callout type="warn">
	`tx.gas` is not available when gas is paid from address balances. Use `tx.coin()` instead for
	portable code.
</Callout>
