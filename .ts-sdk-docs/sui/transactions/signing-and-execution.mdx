...
description: Sign transactions and execute them on the Sui network
keywords:
  - signing
  - execution
  - simulate
  ...
  - keypair
questions:
  - How do I sign a Sui transaction in TypeScript?
  - How do I execute a transaction on Sui?
  - How do I get transaction results?
answer: >-
  Sign transactions with a Keypair or Signer, then execute them via a Sui client. The SDK supports
  signing and executing in one step or separately for sponsored/multisig flows.
goal:
  description: Reader can sign and execute transactions on the Sui network
  requires:
    - has_frontmatter:
        - title
        - description
