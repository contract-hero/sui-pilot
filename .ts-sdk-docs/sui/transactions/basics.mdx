...
keywords:
  ...
  - codegen
questions:
  - How do I build a transaction in the Sui SDK?
  - How do I call a Move function from TypeScript?
  - How do I split and transfer coins in a transaction?
answer: >-
  Use the Transaction class to build programmable transaction blocks: chain commands like
  splitCoins, mergeCoins, moveCall, and transferObjects into a single atomic transaction.
goal:
  description: >-
    Reader can construct programmable transaction blocks with the Transaction API
  requires:
    - has_frontmatter:
        - title
        - description
