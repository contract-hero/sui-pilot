---
title: Querying Data
description: 'Read objects, coins, balances, dynamic fields, and history with any Sui client'
keywords:
  - Sui client
  - getObject
  - listOwnedObjects
...
questions:
  ...
  - How do I use Querying Data?
  - How does Objects work?
  - How does Include options work?
answer: 'Read objects, coins, balances, dynamic fields, and history with any Sui client'
goal:
  description: >-
    Reader can read objects, coins, balances, dynamic fields, and history with any Sui client
  requires:
    - has_frontmatter:
        - title
        - description
