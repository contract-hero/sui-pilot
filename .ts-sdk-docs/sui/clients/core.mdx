---
title: Core API
description: The transport-agnostic client contract that SDKs and libraries build against
keywords:
  - Core API
  - ClientWithCoreApi
  - transport-agnostic
...
questions:
  - What is Core API?
  - How do I use Core API?
  - How does ClientWithCoreApi work?
  - How does The contract work?
answer: The transport-agnostic client contract that SDKs and libraries build against
goal:
  description: >-
    Reader understands the transport-agnostic client contract that SDKs and libraries build against
  requires:
    - has_frontmatter:
        - title
        - description
