...
keywords:
  ...
  - protocol buffers
questions:
  - What is SuiGrpcClient?
  - How do I use SuiGrpcClient?
  - How does gRPC-specific options work?
  - How does Transport options work?
answer: >-
  Connect to Sui over gRPC, with native service clients and real-time subscriptions
goal:
  description: >-
    Reader can connect to Sui over gRPC, with native service clients and real-time subscriptions
  requires:
    - has_frontmatter:
        - title
        - description
