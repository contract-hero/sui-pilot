...
description: >-
  Migrate from SDK version 0.37 to 0.38 with updated module structure and API changes.
keywords:
  - migration
  - 0.38.0
  - upgrade
  ...
  - refactoring
questions:
  - What changed in the Migrate to 0.38.0 migration?
  - How do I migrate to Migrate to 0.38.0?
answer: >-
  Migrate from SDK version 0.37 to 0.38 with updated module structure and API changes.
goal:
  description: >-
    Reader can migrate from SDK version 0.37 to 0.38 with updated module structure and API changes
  requires:
    - has_frontmatter:
        - title
        - description
...
The 1.0 release of the SDK contains many additional changes. This document might help as an
...
- A more stable JSON-RPC API has reduced the need for many of the SDK getter methods, which are now
  deprecated.
