...
description: Migrate from SDK version 0.37 to 0.38 with updated module structure and API changes.
keywords:
  [migration, 0.38.0, upgrade, breaking changes, Sui TypeScript SDK, module structure, refactoring]
---
