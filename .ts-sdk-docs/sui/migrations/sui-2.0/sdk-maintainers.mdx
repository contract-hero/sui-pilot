...
keywords:
  ...
  - breaking changes
questions:
  - What changed in the SDK Maintainers migration?
  - How do I migrate to SDK Maintainers?
  - How does Use ClientWithCoreApi work?
  - How does Access data through client.core methods work?
answer: Migration guide for SDK maintainers and library authors upgrading to 2.0
goal:
  description: >-
    Reader understands migration guide for SDK maintainers and library authors upgrading to 2.0
  requires:
    - has_frontmatter:
        - title
        - description
