...
keywords:
  ...
  - transport
questions:
  - What changed in the Migrating from JSON-RPC migration?
  - How do I migrate to Migrating from JSON-RPC?
  - How does Choosing a target client work?
  - How does Quick migration to gRPC work?
answer: Migrate deprecated JSON-RPC code to shared gRPC and GraphQL top-level methods
goal:
  description: >-
    Reader can migrate deprecated JSON-RPC code to shared gRPC and GraphQL top-level methods
  requires:
    - has_frontmatter:
        - title
        - description
