...
keywords:
  ...
  - breaking changes
questions:
  - What changed in the @mysten/suins migration?
  - How do I migrate to @mysten/suins?
  - How does Custom package IDs work?
answer: Migrate @mysten/suins to 2.0 with client extension pattern
goal:
  description: Reader can migrate @mysten/suins to 2.0 with client extension pattern
  requires:
    - has_frontmatter:
        - title
        - description
