...
keywords:
  ...
  - breaking changes
questions:
  - What changed in the @mysten/sui migration?
  - How do I migrate to @mysten/sui?
  - How does Removal of SuiClient exports work?
  - How does Network parameter required work?
answer: >-
  Migrate @mysten/sui from 1.x to 2.0 with gRPC clients, Core API, and BCS changes
goal:
  description: >-
    Reader can migrate @mysten/sui from 1.x to 2.0 with gRPC clients, Core API, and BCS changes
  requires:
    - has_frontmatter:
        - title
        - description
