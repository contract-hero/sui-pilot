...
keywords:
  ...
  - breaking changes
questions:
  - What changed in the @mysten/dapp-kit migration?
  - How do I migrate to @mysten/dapp-kit?
  - How does Step-by-step migration work?
  - How does CSS and theming changes work?
answer: Migrate @mysten/dapp-kit to the new dapp-kit-react package in 2.0
goal:
  description: Reader can migrate @mysten/dapp-kit to the new dapp-kit-react package in 2.0
  requires:
    - has_frontmatter:
        - title
        - description
...
<Callout type="info">
	The legacy `@mysten/dapp-kit` package only supports the deprecated JSON RPC API and will not
