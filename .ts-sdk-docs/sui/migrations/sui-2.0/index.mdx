...
keywords:
  ...
  - '@mysten packages'
questions:
  - What changed in the Migrate to 2.0 migration?
  - How do I migrate to Migrate to 2.0?
  - How does Quick reference work?
  - How does Common migration patterns work?
answer: Migration guide for Sui TypeScript SDK 2.0 covering all @mysten packages
goal:
  description: Reader understands what Migrate to 2.0 provides and how to get started
  requires:
    - has_frontmatter:
        - title
        - description
