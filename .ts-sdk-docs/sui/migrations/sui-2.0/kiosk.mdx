...
keywords:
  ...
  - breaking changes
questions:
  - What changed in the @mysten/kiosk migration?
  - How do I migrate to @mysten/kiosk?
  - 'How does Removed: transactionBlock parameter work?'
  - 'How does Removed: low-level helper functions work?'
answer: >-
  Migrate @mysten/kiosk to 2.0 with client extension pattern and KioskTransaction
goal:
  description: >-
    Reader can migrate @mysten/kiosk to 2.0 with client extension pattern and KioskTransaction
  requires:
    - has_frontmatter:
        - title
        - description
