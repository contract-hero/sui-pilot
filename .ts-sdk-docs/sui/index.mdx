...
description: TypeScript SDK for building on the Sui blockchain
keywords:
  - Sui
  - TypeScript SDK
  - quick start
  ...
  - network
questions:
  - How do I install the Sui TypeScript SDK?
  - How do I connect to a Sui network in TypeScript?
  - What is @mysten/sui?
answer: >-
  The Sui TypeScript SDK (@mysten/sui) is the official SDK for building on Sui, providing clients
  for gRPC/GraphQL/JSON-RPC, transaction building, cryptographic signing, and BCS serialization.
goal:
  description: >-
    Reader can install @mysten/sui and make their first RPC call to the Sui network
  requires:
    - has_frontmatter:
        - title
        - description
