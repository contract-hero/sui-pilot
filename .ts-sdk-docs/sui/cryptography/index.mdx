...
keywords:
  ...
  - Sui
questions:
  - What cryptographic schemes does Sui support?
  - How do I sign transactions in TypeScript?
  - What is the Signer interface in the Sui SDK?
answer: >-
  The Sui SDK supports Ed25519, Secp256k1, and Secp256r1 keypairs, plus external signers (AWS KMS,
  GCP KMS, Ledger, WebCrypto, Passkey) through a unified Signer interface.
goal:
  description: >-
    Reader understands the cryptographic primitives available in the Sui SDK for signing and
    verification
  requires:
    - has_frontmatter:
        - title
