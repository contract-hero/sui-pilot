...
keywords:
  ...
  - TypeScript SDK
questions:
  - How do I create a keypair in the Sui SDK?
  - How do I import a private key in the Sui SDK?
  - What keypair types does Sui support?
answer: >-
  Create keypairs with Ed25519Keypair.generate(), import from private keys or mnemonics, and use
  them to sign transactions and messages on Sui.
goal:
  description: >-
    Reader can create, import, and use cryptographic keypairs for Sui transactions
  requires:
    - has_frontmatter:
        - title
        - description
