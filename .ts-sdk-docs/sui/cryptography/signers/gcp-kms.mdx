...
keywords:
  ...
  - TypeScript SDK
questions:
  - How do I sign Sui transactions with GCP KMS Signer?
  - How do I set up GCP KMS Signer?
  - How does Creating a signer work?
answer: Sign Sui transactions with a key stored in Google Cloud Key Management Service
goal:
  description: >-
    Reader can sign Sui transactions with a key stored in Google Cloud Key Management Service
  requires:
    - has_frontmatter:
        - title
        - description
