...
keywords:
  ...
  - TypeScript SDK
questions:
  - How do I sign Sui transactions with Ledger Signer?
  - How do I set up Ledger Signer?
  - How does Creating a signer work?
answer: Sign Sui transactions with a Ledger hardware wallet
goal:
  description: Reader can sign Sui transactions with a Ledger hardware wallet
  requires:
    - has_frontmatter:
        - title
        - description
