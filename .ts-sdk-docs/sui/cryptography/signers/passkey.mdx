---
title: Passkey
description: Use WebAuthn passkeys for Sui transaction signing.
keywords:
  - passkey
  - WebAuthn
  - PasskeyKeypair
  ...
  - SIP-9
questions:
  - How do I sign Sui transactions with Passkey?
  - How do I set up Passkey?
  - How does Create a new passkey work?
  - How does Recover a passkey work?
answer: Use WebAuthn passkeys for Sui transaction signing.
goal:
  description: Reader can use WebAuthn passkeys for Sui transaction signing
  requires:
    - has_frontmatter:
        - title
        - description
