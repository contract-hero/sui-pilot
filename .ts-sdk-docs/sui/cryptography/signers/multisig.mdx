...
description: Create multi-signature transactions with multiple signers on Sui.
keywords:
  - multisig
  - multi-signature
  - MultiSigPublicKey
  ...
  - TypeScript SDK
questions:
  - How do I sign Sui transactions with Multi-Signature Transactions?
  - How do I set up Multi-Signature Transactions?
  - How does Creating a MultiSigPublicKey work?
  - How does Combining signatures with a MultiSigPublicKey work?
answer: Create multi-signature transactions with multiple signers on Sui.
goal:
  description: Reader can create multi-signature transactions with multiple signers on Sui
  requires:
    - has_frontmatter:
        - title
        - description
