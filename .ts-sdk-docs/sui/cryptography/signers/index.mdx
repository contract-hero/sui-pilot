...
keywords:
  ...
  - TypeScript SDK
questions:
  - How do I sign Sui transactions with Signers?
  - How do I set up Signers?
  - How does External signers work?
  - How does Other Signer implementations work?
answer: >-
  Signer implementations beyond keypairs — cloud KMS, Ledger, Web Crypto, passkeys, and multisig
goal:
  description: Reader understands what Signers provides and how to get started
  requires:
    - has_frontmatter:
        - title
        - description
