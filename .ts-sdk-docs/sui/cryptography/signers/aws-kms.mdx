...
keywords:
  ...
  - TypeScript SDK
questions:
  - How do I sign Sui transactions with AWS KMS Signer?
  - How do I set up AWS KMS Signer?
  - How does Creating a signer work?
answer: Sign Sui transactions with a key stored in AWS Key Management Service
goal:
  description: >-
    Reader can sign Sui transactions with a key stored in AWS Key Management Service
  requires:
    - has_frontmatter:
        - title
        - description
