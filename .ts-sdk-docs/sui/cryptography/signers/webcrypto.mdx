...
keywords:
  ...
  - session keys
questions:
  - How do I sign Sui transactions with Web Crypto Signer?
  - How do I set up Web Crypto Signer?
  - How does Create a new signer work?
  - How does Persisting and recovering the keypair work?
answer: >-
  Sign transactions using the Web Crypto API for secure browser-based key management
goal:
  description: >-
    Reader can sign transactions using the Web Crypto API for secure browser-based key management
  requires:
    - has_frontmatter:
        - title
        - description
