...
keywords:
  ...
  - Sui
questions:
  - What is The @mysten/sui/utils package?
  - How do I get started with The @mysten/sui/utils package?
  - How does Constants work?
  - How does Formatters work?
answer: >-
  Utility functions for addresses, coins, and common operations in the Sui TypeScript SDK.
goal:
  description: >-
    Reader understands what The @mysten/sui/utils package provides and how to get started
  requires:
    - has_frontmatter:
        - title
        - description
