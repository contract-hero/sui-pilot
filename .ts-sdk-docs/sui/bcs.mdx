---
title: BCS
description: Binary Canonical Serialization for encoding Sui Move types.
keywords:
  - BCS
  ...
  - TypeScript
questions:
  - How do I use BCS in the Sui SDK?
  - How do I serialize transaction data?
  - What BCS types are built into @mysten/sui?
answer: >-
  The @mysten/sui package re-exports BCS utilities for serializing and deserializing Sui-specific
  types like addresses, objects, and transaction data.
goal:
  description: Reader can use the BCS module in @mysten/sui for serialization
  requires:
    - has_frontmatter:
        - title
        - description
...
<Callout type="warn">
	...
	cause parsing to fail. Use `content` for parsing Move struct fields, as described under
	[objectBcs](/sui/clients/querying#objectbcs).
</Callout>
