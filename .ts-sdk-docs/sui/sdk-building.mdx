...
keywords:
  ...
  - transport-agnostic
questions:
  - How do I build a custom SDK on Sui?
  - How do I extend @mysten/sui?
  - What patterns should I use for building Sui SDKs?
answer: >-
  Build custom SDKs by composing @mysten/sui primitives: extend the client, create typed transaction
  builders with codegen, and use BCS for serialization.
goal:
  description: Reader can build custom SDKs on top of @mysten/sui
  requires:
    - has_frontmatter:
        - title
        - description
