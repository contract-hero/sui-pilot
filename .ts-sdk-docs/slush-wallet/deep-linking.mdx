...
questions:
  ...
  - How do I use Deep Linking?
  - How does URL schemes work?
  - How does Universal links and app links work?
answer: >-
  Configure deep links to open Slush Wallet directly to specific screens or actions.
goal:
  description: >-
    Reader can configure deep links to open Slush Wallet directly to specific screens or actions
  requires:
    - has_frontmatter:
        - title
        - description
