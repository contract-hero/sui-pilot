...
questions:
  ...
  - How do I use App Integration?
  - How does Setup work?
  - How does Supported features work?
answer: >-
  Connect your app to Slush Wallet using the Slush Wallet SDK and wallet standard.
goal:
  description: >-
    Reader can connect your app to Slush Wallet using the Slush Wallet SDK and wallet standard
  requires:
    - has_frontmatter:
        - title
        - description
...
<Callout type="info">
	...
	the Slush wallet. [Read how to integrate with dapp-kit.](/dapp-kit/getting-started/react)
</Callout>
