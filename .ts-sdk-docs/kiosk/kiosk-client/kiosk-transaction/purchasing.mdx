...
description: Purchase items from kiosks with automatic transfer policy rule resolution.
keywords:
  - kiosk purchase
  - transfer policy
  - rules resolution
  ...
  - TypeScript
questions:
  - What is Purchasing from a kiosk?
  - How do I use Purchasing from a kiosk?
  - How to purchase?
  - How does Supporting a custom rule work?
answer: Purchase items from kiosks with automatic transfer policy rule resolution.
goal:
  description: >-
    Reader understands purchase items from kiosks with automatic transfer policy rule resolution
  requires:
    - has_frontmatter:
        - title
        - description
