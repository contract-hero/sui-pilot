...
keywords:
  ...
  - Sui
questions:
  - What is Managing Owned Kiosk?
  - How do I use Managing Owned Kiosk?
  - How does Available functions work?
answer: >-
  Manage kiosk items by placing, listing, delisting, and withdrawing using the Kiosk SDK.
goal:
  description: >-
    Reader can manage kiosk items by placing, listing, delisting, and withdrawing using the Kiosk
    SDK
  requires:
    - has_frontmatter:
        - title
