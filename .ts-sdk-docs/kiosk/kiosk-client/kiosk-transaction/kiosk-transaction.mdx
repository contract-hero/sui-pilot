...
description: 'Build kiosk transactions for listing, purchasing, and managing items on Sui.'
keywords:
  - KioskTransaction
  - transaction builder
  - kiosk
  ...
  - TypeScript
questions:
  - What is KioskTransaction?
  - How do I use KioskTransaction?
  - How does Using an existing kiosk work?
  - How does Creating a new kiosk work?
answer: 'Build kiosk transactions for listing, purchasing, and managing items on Sui.'
goal:
  description: >-
    Reader can build kiosk transactions for listing, purchasing, and managing items on Sui
  requires:
    - has_frontmatter:
        - title
        - description
