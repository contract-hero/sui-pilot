...
questions:
  - What is Querying?
  - How do I use Querying?
  - How does Querying owned kiosks work?
  - How does Querying kiosk content work?
answer: >-
  Query kiosk contents, owned kiosks, items, and transfer policies using the Kiosk SDK.
goal:
  description: >-
    Reader can query kiosk contents, owned kiosks, items, and transfer policies using the Kiosk SDK
  requires:
    - has_frontmatter:
        - title
        - description
