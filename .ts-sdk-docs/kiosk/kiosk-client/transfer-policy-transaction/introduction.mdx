...
description: Create and manage transfer policies for kiosk items using the Kiosk SDK.
keywords:
  ...
  - TypeScript
questions:
  - What is TransferPolicyTransaction?
  - How do I use TransferPolicyTransaction?
  - How does Using an existing transfer policy work?
  - How does Creating a new transfer policy work?
answer: Create and manage transfer policies for kiosk items using the Kiosk SDK.
goal:
  description: >-
    Reader can create and manage transfer policies for kiosk items using the Kiosk SDK
  requires:
    - has_frontmatter:
        - title
        - description
