...
description: Use the TransferPolicyTransaction manager to add rules and withdraw profits.
keywords:
  ...
  - Kiosk SDK
questions:
  - What is Using the manager?
  - How do I use Using the manager?
  - How does Available functions work?
answer: Use the TransferPolicyTransaction manager to add rules and withdraw profits.
goal:
  description: >-
    Reader can use the TransferPolicyTransaction manager to add rules and withdraw profits
  requires:
    - has_frontmatter:
        - title
        - description
