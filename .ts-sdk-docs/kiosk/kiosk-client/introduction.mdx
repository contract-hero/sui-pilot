...
keywords:
  ...
  - testnet
questions:
  - What is Kiosk Client?
  - How do I use Kiosk Client?
  - How does Setting up the kiosk extension work?
answer: >-
  Introduction to the KioskClient extension for querying and managing kiosks on Sui
goal:
  description: >-
    Reader understands introduction to the KioskClient extension for querying and managing kiosks on
    Sui
  requires:
    - has_frontmatter:
        - title
