...
keywords:
  ...
  - Sui
questions:
  - What is Migrating from Kiosk SDK V1?
  - How do I use Migrating from Kiosk SDK V1?
  - How does Placing an item to kiosk and listing it for sale work?
  - How does Create a new kiosk work?
answer: Migrate from Kiosk SDK v1 to the current version with the builder-pattern API
goal:
  description: >-
    Reader can migrate from Kiosk SDK v1 to the current version with the builder-pattern API
  requires:
    - has_frontmatter:
        - title
        - description
