...
keywords:
  ...
  - TypeScript
questions:
  - What is Advanced Examples?
  - How do I use Advanced Examples?
  - How does Minting a SuiFren work?
  - How does Mixing two Suifrens work?
answer: Advanced Kiosk SDK usage patterns and code examples for complex scenarios
goal:
  description: >-
    Reader understands advanced Kiosk SDK usage patterns and code examples for complex scenarios
  requires:
    - has_frontmatter:
        - title
        - description
