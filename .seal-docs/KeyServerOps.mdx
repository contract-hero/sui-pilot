...
```
6. To use the SDK against your localnet, point a `SuiClient` at the local fullnode and list your localnet key server in `serverConfigs`. See [Using Seal](./UsingSeal.mdx) for the full client flow.
```ts
